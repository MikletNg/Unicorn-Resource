...
read -e -p "Stack name: " -i "SumerianResource" STACK_NAME
read -e -p "Code name of project (ST/CX/...): " -i "Unicorn" CODENAME
read -e -p "Production name of Sumerian: " -i "Prototype" PRODNAME
